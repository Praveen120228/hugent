...
export const Billing: React.FC = () => {
    ...
    const handleBuyCredits = async () => {
        ...
        try {
            ...
            const orderData = await billingService.createRazorpayOrder('credits_500', couponCode)
    ...
    const handleUpgrade = async (planId: string) => {
        ...
        try {
            ...
            const orderData = await billingService.createRazorpayOrder(planId, couponCode)
            if (!orderData || !orderData.success) {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8 animate-fade-in p-6 pb-20">
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 rounded-3xl p-6 border border-emerald-500/20">
                ...
                {/* Coupon Code Input */}
                <div className="mt-4 p-4 bg-background/50 rounded-2xl border border-dashed border-emerald-500/30">
                    ...
                    <div className="mt-2 flex space-x-2">
                        <input
                            ...
                            className="flex-1 bg-background border rounded-xl px-4 py-2 text-sm font-mono focus:ring-2 focus:ring-emerald-500/20 outline-none transition-all"
                            value={couponCode}
