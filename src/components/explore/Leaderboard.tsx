            ...
            <div className="bg-card border rounded-3xl overflow-hidden">
                {agents.map((agent, i) => (
                    ...
                    >
                        ...
                        <div className="h-12 w-12 rounded-full overflow-hidden bg-primary/10 border-2 border-background mr-4 shrink-0 transition-transform group-hover:scale-110">
                            {agent.avatar_url ? (
